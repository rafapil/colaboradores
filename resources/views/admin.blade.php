                        ...
                        <div data-duration-in="300" data-duration-out="100" class="w-tabs">
                            ...
                            <div class="w-tab-content">
                                ...
                                <div data-w-tab="Squad" class="w-tab-pane" id="w-tabs-0-data-w-pane-2" role="tabpanel"
                                    ...
                                    <div class="w-form">
                                        <form id="wf-form-squad" name="wf-form-squad" data-name="squad"><label
                                                for="name-3" class="field-label-3">Name</label><input type="text"
                                                class="w-input" maxlength="256" name="name-2" data-name="Name 2"
                                                placeholder="" id="name-2"><input type="submit" value="Submit"
                                                data-wait="Please wait..." class="w-button"></form>
                                        <div class="w-form-done">
                                ...
                                <div data-w-tab="Centro de Custo" class="w-tab-pane" id="w-tabs-0-data-w-pane-3"
                                    ...
                                    <div class="w-form">
                                        <form id="wf-form-squad" name="wf-form-squad" data-name="squad"><label
                                                for="name-3" class="field-label-4">Name</label><input type="text"
                                                class="w-input" maxlength="256" name="name-2" data-name="Name 2"
                                                placeholder="" id="name-2"><input type="submit" value="Submit"
                                                data-wait="Please wait..." class="w-button"></form>
                                        <div class="w-form-done">
                                ...
                                <div data-w-tab="Estabelecimento" class="w-tab-pane" id="w-tabs-0-data-w-pane-4"
                                    ...
                                    <div class="w-form">
                                        <form id="wf-form-squad" name="wf-form-squad" data-name="squad"><label
                                                for="name-3" class="field-label-5">Name</label><input type="text"
                                                class="w-input" maxlength="256" name="name-2" data-name="Name 2"
                                                placeholder="" id="name-2"><input type="submit" value="Submit"
                                                data-wait="Please wait..." class="w-button"></form>
                                        <div class="w-form-done">
                                ...
                                <div data-w-tab="Empresa" class="w-tab-pane" id="w-tabs-0-data-w-pane-5" role="tabpanel"
                                    ...
                                    <div class="w-form">
                                        <form id="wf-form-squad" name="wf-form-squad" data-name="squad"><label
                                                for="name-3" class="field-label-6">Name</label><input type="text"
                                                class="w-input" maxlength="256" name="name-2" data-name="Name 2"
                                                placeholder="" id="name-2"><input type="submit" value="Submit"
                                                data-wait="Please wait..." class="w-button"></form>
                                        <div class="w-form-done">
