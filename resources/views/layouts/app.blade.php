<!doctype html>
<html data-wf-site="#" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/colaborador">Painel de controle</a>
                                <a class="dropdown-item" href="/usuario">Dados pessoais</a>
